...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'urdf', 'plugins'), glob(os.path.join('urdf', 'plugins', '*.xacro'))), # Include the plugins folder and its contents
        (os.path.join('share', package_name, 'worlds'), glob(os.path.join('worlds', '*.sdf'))), # Include the worlds folder and its contents
